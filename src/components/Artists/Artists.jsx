            ...
            <div className="artists-cards">
                <div className="artist-cards-block-a">
                    <figure className="artists-img-card">
                        <img src="/img/artist/artist1/artist1.png" alt="artist logo" className="artists-img" />
                        <figcaption class="artists-card-title">
                            <img src="/img/artist/artist1/artist-logo.png" alt="artist popular nft" className='artist-logo-img' />
                    ...
                    <figure className="artists-img-card">
                        <img src="/img/artist/artist2/artist2.png" alt="artist logo" className="artists-img" />
                        <figcaption class="artists-card-title">
                            <img src="/img/artist/artist2/artist-logo2.png" alt="artist popular nft" className='artist-logo-img' />
                            <div className='artist-logo'>
                                <div className='artist-logo-title'>Owner</div>
                    ...
                    <figure className="artists-img-card">
                        <img src="/img/artist/artist4/artist4.png" alt="artist logo" className="artists-img" />
                        <figcaption class="artists-card-title">
                            <img src="/img/artist/artist3/artist-logo3.png" alt="artist popular nft" className='artist-logo-img' />
                            <div className='artist-logo'>
                                <div className='artist-logo-title'>Owner</div>
                    ...
                    <figure className="artists-img-card">
                        <img src="/img/artist/artist5/artist5.png" alt="artist logo" className="artists-img" />
                        <figcaption class="artists-card-title">
                            <img src="/img/artist/artist5/artist-logo5.png" alt="artist popular nft" className='artist-logo-img' />
                            <div className='artist-logo'>
                                <div className='artist-logo-title'>Owner</div>
